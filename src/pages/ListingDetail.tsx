...
import { Leaf, ArrowLeft, MapPin, Clock, User, Package, Calendar, MessageCircle } from "lucide-react";
...
const ListingDetail = () => {
  ...
  const handleClaim = async () => {
    ...
    try {
      ...
      toast({
        title: "Success!",
        description: "Food claimed successfully. Contact the donor to arrange pickup.",
      });
        ...
        <Card className="border-border overflow-hidden">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex gap-4 pt-4">
                ...
                <Dialog>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Are you sure you want to claim this food? You'll be responsible for picking it up.
                      </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4">
                      <p className="text-sm text-muted-foreground">
                        After claiming, you can chat with {listing.profiles.name} to coordinate pickup.
                      </p>
              ...
              {isClaimed && !isDonor && (
                <Button className="flex-1" onClick={() => navigate(`/chat/${listing.donor_id}`)}>
                  <MessageCircle className="h-4 w-4 mr-2" />
                  Chat with Donor
                </Button>
              )}
              {isDonor && isClaimed && (
                <Button className="flex-1" onClick={() => navigate(`/chat/${listing.claimed_by}`)}>
                  <MessageCircle className="h-4 w-4 mr-2" />
                  Chat with Receiver
                </Button>
              )}
